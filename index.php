    ...
    <section class="py-5 mb-5">
        <div class="container">
            <div class="recent-work-header row text-center pb-5">
                <h2 class="col-md-6 m-auto h2 semi-bold-600 py-5">Update News</h2>
            </div>
            <div class="row gy-5 g-lg-5 mb-4">
                <?php
                $db_connection = mysqli_connect("us-cdbr-east-04.cleardb.com","b4d4b5e8043e16","1109892b","heroku_afcc4630639690d");
                $select = mysqli_query($db_connection, "SELECT * FROM work ORDER BY ID DESC LIMIT 6");
                while ($row = $select->fetch_assoc()) {                         
                ?>
                <!-- Start Recent Work -->
                <div class="col-md-4 mb-3">
                    <a href="work-single.php?id=<?php echo $row['id']; ?>" class="recent-work card border-0 shadow-lg overflow-hidden">
                        <img class="recent-work-img card-img" src="./admin-master/img/<?php echo $row['foto']; ?>" alt="Card image">
                        <div class="recent-work-vertical card-img-overlay d-flex align-items-end">
                            <div class="recent-work-content text-start mb-3 ml-3 text-dark">
                                <h3 class="card-title light-300"><?php echo $row['judul']; ?></h3>
